...
<div class="bg-change overflow-x-hidden ">
	<div class="row">
		...
		<div class="row font font-page">Add User Profile</div>
	</div>
	<div class="row">
		<div class="col-2"> 
					...
					<form action="/userAdd" method="POST" enctype="multipart/form-data">
						...
						<div class="row col-11" style="margin-top:20px; margin-left: 60px;">
							...
							<div class="row" style="margin-top:10px;">
								<div class="col-5 mb-2 form-add">
								  	<input value="{{ old('inputName') }}" id="inputName" name="inputName" type="text" class="form-control" placeholder="Name :">
								</div>
								<div class="col-5 mb-2 form-add">
									<input value="{{ old('inputLastName') }}" id="inputLastName" name="inputLastName" type="text" class="form-control" placeholder="Last name :">
								</div>
							</div>
						</div>
						<div class="row col-11" style="margin-top:20px; margin-left: 60px;">
							<div class="col-5 mb-2 form-add">
							  	...
							  	<div style="margin-top:10px;">
							  		<input value="{{ old('inputEmail') }}" id="inputEmail" name="inputEmail" type="email" class="form-control" placeholder="E-mail :">
							  	</div>
							</div>
							<div class="col-5 mb-2 form-add">
								...
								<div style="margin-top:10px;">
									<input value="{{ old('inputPassword') }}" id="inputPassword" name="inputPassword" type="text" class="form-control" placeholder="Password :">
								</div>
							</div>
						</div>
						<div class="row col-11" style="margin-top:10px; margin-left: 60px;">
							<div class="col-5 mb-3 form-add">
								...
								<select value="{{ old('inputStatus') }}" id="inputStatus" name="inputStatus" class="form-select">
							...
							<div class="col-5 mb-3 form-add">
								...
								<div class="input-group">
									<input value="{{ old('inputPhoneNum') }}" id="inputPhoneNum" name="inputPhoneNum" type="text" class="form-control" placeholder="Phone number :">
								</div>
							</div>
						</div>
